...
// StartupManager.cpp : Defines the class behaviors for the application.
//
...
// CStartupManagerApp construction
...
// The one and only CStartupManagerApp object

CStartupManagerApp theApp;


// CStartupManagerApp initialization
